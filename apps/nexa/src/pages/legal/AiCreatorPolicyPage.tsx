  ...
  return (
    <LegalPageLayout title="AI Creator Policy" lastUpdated="July 15, 2026">
      <section>
        ...
        <p>
          NEXA's Creator Forge is designed for builders. AI Creators who publish Personas, Lorebooks, or custom voices must abide by these rules to maintain a high-quality ecosystem.
        </p>
      </section>
