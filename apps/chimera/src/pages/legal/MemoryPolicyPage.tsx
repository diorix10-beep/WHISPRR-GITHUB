  ...
  return (
    <LegalPageLayout title="AI Memory Policy" lastUpdated="July 15, 2026">
      <section>
        ...
        <p>
          CHIMERA utilizes advanced AI Memory systems to allow Personas to remember you across multiple sessions. This memory is extracted dynamically from your conversations to build long-term context.
        </p>
      </section>
