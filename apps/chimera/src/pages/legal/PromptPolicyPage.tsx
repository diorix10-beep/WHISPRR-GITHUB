  ...
  return (
    <LegalPageLayout title="Prompt Policy" lastUpdated="July 15, 2026">
      ...
      <section>
        ...
        <p>
          "Jailbreaking"—the act of using complex prompts to bypass the safety protocols of CHIMERA or underlying LLM providers—is strictly forbidden. We monitor for known jailbreak patterns, and repeated attempts will trigger automatic account suspension.
        </p>
      </section>
