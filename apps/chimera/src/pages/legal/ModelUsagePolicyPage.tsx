  ...
  return (
    <LegalPageLayout title="Model Usage Policy" lastUpdated="July 15, 2026">
      <section>
        ...
        <p>
          CHIMERA provides access to a variety of LLMs (Large Language Models). Some models are available for free, while advanced models are restricted to CHIMERA+ subscribers. We do not guarantee the continuous availability of any specific third-party model.
        </p>
      </section>
