    ...
    switch (activeTab) {
      ...
      case 'ai-transparency':
        return (
          <div className="space-y-4">
            <p>
              WHISPRR operates with complete AI integrity. Artificial intelligence models, including CHIMERA (our conversational character framework), are designed to respect privacy boundary layers:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Gemini API Boundaries:</strong> CHIMERA's conversational components operate through secure, private API endpoints. Your inputs are parsed to generate responses but are never stored by provider networks for model fine-tuning.</li>
