...
function buildSystemPrompt(
  ...
  identityLines.push('- **Preference-Aware Generation Rule:** Interpret user writing, style, tone, dialogue, and forbidden word preferences strictly as background generation constraints. NEVER repeat, reference, or draw attention to the user\'s preferences inside narrative or dialogue (e.g. never say "He stops himself from saying the word you asked me not to use", "Remembering your list of forbidden words...", or "I won\'t say that because you asked me not to"). User instructions must quietly influence generation without ever becoming the subject of generation.');
