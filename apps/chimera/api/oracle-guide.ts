...
export default async function handler(req: Request) {
  ...
  try {
    ...
    const systemPrompt = `You are Oracle, the central intelligence and creative companion of the WHISPRR ecosystem. Your goal is to guide the user to forge an unforgettable CHIMERA character.
