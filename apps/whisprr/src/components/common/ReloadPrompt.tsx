      ...
      <div className="bg-white/95 dark:bg-warm-900/95 backdrop-blur-md rounded-2xl shadow-2xl shadow-warm-950/20 border border-warm-200/80 dark:border-warm-800 p-5 max-w-sm w-full transition-all">
        ...
        <div className="mt-4 flex gap-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold text-xs shadow-md transition-all hover:shadow-lg hover:-translate-y-0.5"
          >
            <RefreshCw size={14} />
            Refresh WHISPRR
          </button>
